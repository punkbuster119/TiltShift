...
public class BotControlScript : MonoBehaviour
{
	...
	void FixedUpdate ()
	{
		...
		anim.SetFloat("Speed", v * 0.2f);							// set our animator's float parameter 'Speed' equal to the vertical input axis				
		anim.SetFloat("Direction",h * 0.2f); 						// set our animator's float parameter 'Direction' equal to the horizontal input axis		
